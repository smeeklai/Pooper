...
namespace Poopor
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            //new SQLiteConnection(SQLiteFunctions.dbPath).CreateTable<UserInfo_Table_SQLite>();
            //new SQLiteConnection(SQLiteFunctions.dbPath).CreateTable<Poop_Table_SQLite>();
